...
from .settings import UOM_LENGTH
...
class ProductAttributeValue(models.Model):
    ...
    material = fields.Many2one(comodel_name='metal.material',string='Material')
    volmass = fields.Float(string='Volumic mass',related='material.volmass',readonly=True )
